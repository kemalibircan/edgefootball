          ...
          <div className="card wide guest-upload-zone">
            ...
            <div className="guest-thumb-grid">
              {sliderDraftImages.map((image, index) => (
                <article key={`admin-slider-thumb-${index}`} className="guest-thumb">
      ...
      {showAdminTools ? (
        <section className="grid">
          <div className="card wide">
            ...
            <p className="help-text">Kullanicilarin gonderdigi transaction id bildirimleri burada gorunur.</p>
              ...
              <tbody>
                {(paymentNotices || []).map((notice) => (
                  <tr key={`payment-notice-${notice.id}`}>
                    ...
                    <td>{notice.chain}</td>
                    <td>
                      <code>{notice.transaction_id}</code>
                    </td>
                    <td>{notice.status}</td>
                    <td>
                      <div className="row wrap">
